...
<div class="container border mt-3 rounded-3 w-50">
		<ul class="nav nav-pills nav-fill row">
			...
			<a class="nav-link" style="color: black;" aria-current="page" href='<c:url value="/diet/recDiet"/>'>
				추천식단
			</a>
			</li>
			<li class="nav-item col-12 col-md-3"><a class="nav-link  active" style="color: black;" aria-current="page" href='<c:url value="/diet/simDiet"/>'>
				간단식단
			</a>
			</li>
