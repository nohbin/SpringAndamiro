		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<button type="button" id="regBtn" class="btn btn-xs pull-right"> Write</button>
				</div>
				<!-- /.panel-heading -->
					...
					<div class='pull-right'>
						<ul class="pagination">
							<c:if test="${pageMaker.prev}">
								<li class="paginate_button previous" btn btn-secondary btn-sm><a href="${pageMaker.startPage-1}">Previous</a></li>
							</c:if>
